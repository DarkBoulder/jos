...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,59,.LM41-.LFBB3
.LM41:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,62,.LM42-.LFBB3
.LM42:
	cmpq	$0, panicstr(%rip)
	je	.L23
	.p2align 4,,10
	.p2align 3
.L20:
	.stabn	68,0,78,.LM43-.LFBB3
.LM43:
	xorl	%edi, %edi
	call	monitor@PLT
	jmp	.L20
.L23:
	.stabn	68,0,64,.LM44-.LFBB3
.LM44:
	movq	%rbp, panicstr(%rip)
	.stabn	68,0,67,.LM45-.LFBB3
.LM45:
#APP
# 67 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,69,.LM46-.LFBB3
.LM46:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,70,.LM47-.LFBB3
.LM47:
	movl	%esi, %edx
	movq	%rdi, %rsi
...
.LM48:
	...
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,70,.LM49-.LFBB3
.LM49:
	leaq	.LC3(%rip), %rdi
	.stabn	68,0,69,.LM50-.LFBB3
.LM50:
	movq	%rax, 16(%rsp)
	.stabn	68,0,70,.LM51-.LFBB3
.LM51:
	xorl	%eax, %eax
	.stabn	68,0,69,.LM52-.LFBB3
.LM52:
	movl	$48, 4(%rsp)
	.stabn	68,0,70,.LM53-.LFBB3
.LM53:
	call	cprintf@PLT
	.stabn	68,0,71,.LM54-.LFBB3
.LM54:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,72,.LM55-.LFBB3
.LM55:
	leaq	.LC4(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM57:
	...
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,87,.LM58-.LFBB4
.LM58:
	leaq	224(%rsp), %rax
	.stabn	68,0,88,.LM59-.LFBB4
.LM59:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,87,.LM60-.LFBB4
.LM60:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,88,.LM61-.LFBB4
.LM61:
	leaq	.LC5(%rip), %rdi
	.stabn	68,0,87,.LM62-.LFBB4
.LM62:
	movq	%rax, 16(%rsp)
	.stabn	68,0,88,.LM63-.LFBB4
.LM63:
	xorl	%eax, %eax
	.stabn	68,0,87,.LM64-.LFBB4
.LM64:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,88,.LM65-.LFBB4
.LM65:
	call	cprintf@PLT
	.stabn	68,0,89,.LM66-.LFBB4
.LM66:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,90,.LM67-.LFBB4
.LM67:
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,92,.LM68-.LFBB4
.LM68:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
